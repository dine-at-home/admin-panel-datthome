      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/dashboard/dinners/${dinner.id}/activity`}
              className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium bg-orange-500 text-white rounded-lg hover:bg-orange-600"
            >
              View activity →
            </Link>
            <span
